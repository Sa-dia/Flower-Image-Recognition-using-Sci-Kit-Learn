...
data_path = fr'{os.getenv("USERPROFILE")}/Downloads/Flowers/flowers' 
...
include = {'Daisy', 'Dandelion', 'Jasmine', 
...
dog = imread('C:\\Users\\hossa\\Downloads\\German_Shepherd_-01.jpg', as_gray=True)
